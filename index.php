...
<title>Sistem Pendaftaran Mahasiswa Baru Kwik Kian Gie</title>
...
<div id="loading" style="display:none"><img src="images/loading.gif" /><br />Data Sedang Dimuat.</div>
<body>
<div id="mainPan">
  <div id="leftPan">
  	<div id="leftTopPan">
		<a href="index.php"><img src="https://siva.jsstatic.com/id/52596/images/logo/52596_logo_0_7446727.jpg" title="Consultant" alt="Consultant" border="0" /></a> </div>
		<ul>
			<li><a href="home.php">Beranda</a></li>
			<li><a href="daftar-baru.php">Pendaftaran Mahasiswa Baru</a></li>
			<li><a href="calon-terdaftar.php">Calon Mahasiswa Terdaftar</a></li>
			<li><a href="calon-diterima.php">Calon Mahasiswa Diterima</a></li>
  ...
  <div id="rightPan">
  	<h1>Sistem Online Pendaftaran Mahasiswa Baru<br /><p>Kwik Kian Gie School Of Bussiness</p> </h1>
	<div id="ambil">
